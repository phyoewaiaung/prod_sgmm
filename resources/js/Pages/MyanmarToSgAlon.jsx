                    ...
                    <div className=' pt-4 pb-4'>
                        <div className='me-4 ms-4'>
                            ...
                            <div id='senderPhone' className='flex dark:text-gray-400 border-blue-200 dark:border-blue-500 border p-6 flex-col mb-4 rounded'>
                                ...
                                <input className='dark:text-black dark:bg-gray-400 w-1/2 mt-4 border-b-indigo-400 border-t-0 border-s-0 border-e-0 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50' type="text" name="" id="" value={senderPhone} onChange={senderPhoneChange} />
                            ...
                            <div className='flex dark:text-gray-400 border-blue-200 dark:border-blue-500 border p-6 flex-col mb-4 rounded'>
                                ...
                                <input className='dark:text-black dark:bg-gray-400 w-1/2 mt-4 border-b-indigo-400 border-t-0 border-s-0 border-e-0 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50' type="text" name="" id="" value={senderAddress} onChange={senderAddressChange} />
                            </div>
